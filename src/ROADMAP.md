...
- [x] **Backup & Restore (UI Shell)**: UI for initiating backups and restores created.
...
- [ ] **Backup & Restore (Backend)**: Implement logic for creating and restoring database snapshots.
